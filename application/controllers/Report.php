...
class Report extends CI_Controller {
    ...
    public function export_neraca()
    {
        ...
        $letterCounter++;
        $sheet->setCellValue("{$letters[$letterCounter]}{$rowNo}", $data['q1']['receive_pinjaman_barang']);
        $sheet->getStyle("{$letters[$letterCounter]}{$rowNo}")->getNumberFormat()->setFormatCode('#,##0');
        $letterCounter+=2;
        $sheet->setCellValue("{$letters[$letterCounter]}{$rowNo}", $data['q2']['receive_pinjaman_barang']);
        $sheet->getStyle("{$letters[$letterCounter]}{$rowNo}")->getNumberFormat()->setFormatCode('#,##0');
        $letterCounter+=2;
        $sheet->setCellValue("{$letters[$letterCounter]}{$rowNo}", $data['q3']['receive_pinjaman_barang']);
        $sheet->getStyle("{$letters[$letterCounter]}{$rowNo}")->getNumberFormat()->setFormatCode('#,##0');
        $letterCounter+=2;
        $sheet->setCellValue("{$letters[$letterCounter]}{$rowNo}", $data['q4']['receive_pinjaman_barang']);
        $sheet->getStyle("{$letters[$letterCounter]}{$rowNo}")->getNumberFormat()->setFormatCode('#,##0');
        $letterCounter+=2;
        $sheet->setCellValue("{$letters[$letterCounter]}{$rowNo}", 0);
        $sheet->getStyle("{$letters[$letterCounter]}{$rowNo}")->getNumberFormat()->setFormatCode('#,##0');
        ...
        $letterCounter++;
        $sheet->setCellValue("{$letters[$letterCounter]}{$rowNo}", $data['q1']['receive_pinjaman']);
        $sheet->getStyle("{$letters[$letterCounter]}{$rowNo}")->getNumberFormat()->setFormatCode('#,##0');
        $letterCounter+=2;
        $sheet->setCellValue("{$letters[$letterCounter]}{$rowNo}", $data['q2']['receive_pinjaman']);
        $sheet->getStyle("{$letters[$letterCounter]}{$rowNo}")->getNumberFormat()->setFormatCode('#,##0');
        $letterCounter+=2;
        $sheet->setCellValue("{$letters[$letterCounter]}{$rowNo}", $data['q3']['receive_pinjaman']);
        $sheet->getStyle("{$letters[$letterCounter]}{$rowNo}")->getNumberFormat()->setFormatCode('#,##0');
        $letterCounter+=2;
        $sheet->setCellValue("{$letters[$letterCounter]}{$rowNo}", $data['q4']['receive_pinjaman']);
        $sheet->getStyle("{$letters[$letterCounter]}{$rowNo}")->getNumberFormat()->setFormatCode('#,##0');
        $letterCounter+=2;
        $sheet->setCellValue("{$letters[$letterCounter]}{$rowNo}", 0);
        $sheet->getStyle("{$letters[$letterCounter]}{$rowNo}")->getNumberFormat()->setFormatCode('#,##0');
        ...
        $letterCounter++;
        $sheet->setCellValue("{$letters[$letterCounter]}{$rowNo}", $data['q1']['debt_pokok']);
        $sheet->getStyle("{$letters[$letterCounter]}{$rowNo}")->getNumberFormat()->setFormatCode('#,##0');
        $letterCounter+=2;
        $sheet->setCellValue("{$letters[$letterCounter]}{$rowNo}", $data['q2']['debt_pokok']);
        $sheet->getStyle("{$letters[$letterCounter]}{$rowNo}")->getNumberFormat()->setFormatCode('#,##0');
        $letterCounter+=2;
        $sheet->setCellValue("{$letters[$letterCounter]}{$rowNo}", $data['q3']['debt_pokok']);
        $sheet->getStyle("{$letters[$letterCounter]}{$rowNo}")->getNumberFormat()->setFormatCode('#,##0');
        $letterCounter+=2;
        $sheet->setCellValue("{$letters[$letterCounter]}{$rowNo}", $data['q4']['debt_pokok']);
        $sheet->getStyle("{$letters[$letterCounter]}{$rowNo}")->getNumberFormat()->setFormatCode('#,##0');
        $letterCounter+=2;
        $sheet->setCellValue("{$letters[$letterCounter]}{$rowNo}", 0);
        $sheet->getStyle("{$letters[$letterCounter]}{$rowNo}")->getNumberFormat()->setFormatCode('#,##0');
        ...
        $letterCounter++;
        $sheet->setCellValue("{$letters[$letterCounter]}{$rowNo}", $data['q1']['debt_wajib']);
        $sheet->getStyle("{$letters[$letterCounter]}{$rowNo}")->getNumberFormat()->setFormatCode('#,##0');
        $letterCounter+=2;
        $sheet->setCellValue("{$letters[$letterCounter]}{$rowNo}", $data['q2']['debt_wajib']);
        $sheet->getStyle("{$letters[$letterCounter]}{$rowNo}")->getNumberFormat()->setFormatCode('#,##0');
        $letterCounter+=2;
        $sheet->setCellValue("{$letters[$letterCounter]}{$rowNo}", $data['q3']['debt_wajib']);
        $sheet->getStyle("{$letters[$letterCounter]}{$rowNo}")->getNumberFormat()->setFormatCode('#,##0');
        $letterCounter+=2;
        $sheet->setCellValue("{$letters[$letterCounter]}{$rowNo}", $data['q4']['debt_wajib']);
        $sheet->getStyle("{$letters[$letterCounter]}{$rowNo}")->getNumberFormat()->setFormatCode('#,##0');
        $letterCounter+=2;
        $sheet->setCellValue("{$letters[$letterCounter]}{$rowNo}", 0);
        $sheet->getStyle("{$letters[$letterCounter]}{$rowNo}")->getNumberFormat()->setFormatCode('#,##0');
        ...
        $letterCounter++;
        $sheet->setCellValue("{$letters[$letterCounter]}{$rowNo}", $data['q1']['debt_investasi']);
        $sheet->getStyle("{$letters[$letterCounter]}{$rowNo}")->getNumberFormat()->setFormatCode('#,##0');
        $letterCounter+=2;
        $sheet->setCellValue("{$letters[$letterCounter]}{$rowNo}", $data['q2']['debt_investasi']);
        $sheet->getStyle("{$letters[$letterCounter]}{$rowNo}")->getNumberFormat()->setFormatCode('#,##0');
        $letterCounter+=2;
        $sheet->setCellValue("{$letters[$letterCounter]}{$rowNo}", $data['q3']['debt_investasi']);
        $sheet->getStyle("{$letters[$letterCounter]}{$rowNo}")->getNumberFormat()->setFormatCode('#,##0');
        $letterCounter+=2;
        $sheet->setCellValue("{$letters[$letterCounter]}{$rowNo}", $data['q4']['debt_investasi']);
        $sheet->getStyle("{$letters[$letterCounter]}{$rowNo}")->getNumberFormat()->setFormatCode('#,##0');
        $letterCounter+=2;
        $sheet->setCellValue("{$letters[$letterCounter]}{$rowNo}", 0);
        $sheet->getStyle("{$letters[$letterCounter]}{$rowNo}")->getNumberFormat()->setFormatCode('#,##0');
        ...
        $letterCounter++;
        $sheet->setCellValue("{$letters[$letterCounter]}{$rowNo}", $data['q1']['debt_sukarela']);
        $sheet->getStyle("{$letters[$letterCounter]}{$rowNo}")->getNumberFormat()->setFormatCode('#,##0');
        $letterCounter+=2;
        $sheet->setCellValue("{$letters[$letterCounter]}{$rowNo}", $data['q2']['debt_sukarela']);
        $sheet->getStyle("{$letters[$letterCounter]}{$rowNo}")->getNumberFormat()->setFormatCode('#,##0');
        $letterCounter+=2;
        $sheet->setCellValue("{$letters[$letterCounter]}{$rowNo}", $data['q3']['debt_sukarela']);
        $sheet->getStyle("{$letters[$letterCounter]}{$rowNo}")->getNumberFormat()->setFormatCode('#,##0');
        $letterCounter+=2;
        $sheet->setCellValue("{$letters[$letterCounter]}{$rowNo}", $data['q4']['debt_sukarela']);
        $sheet->getStyle("{$letters[$letterCounter]}{$rowNo}")->getNumberFormat()->setFormatCode('#,##0');
        $letterCounter+=2;
        $sheet->setCellValue("{$letters[$letterCounter]}{$rowNo}", 0);
        $sheet->getStyle("{$letters[$letterCounter]}{$rowNo}")->getNumberFormat()->setFormatCode('#,##0');
        ...
        $letterCounter++;
        $sheet->setCellValue("{$letters[$letterCounter]}{$rowNo}", $data['q1']['debt_repayment']);
        $sheet->getStyle("{$letters[$letterCounter]}{$rowNo}")->getNumberFormat()->setFormatCode('#,##0');
        $letterCounter+=2;
        $sheet->setCellValue("{$letters[$letterCounter]}{$rowNo}", $data['q2']['debt_repayment']);
        $sheet->getStyle("{$letters[$letterCounter]}{$rowNo}")->getNumberFormat()->setFormatCode('#,##0');
        $letterCounter+=2;
        $sheet->setCellValue("{$letters[$letterCounter]}{$rowNo}", $data['q3']['debt_repayment']);
        $sheet->getStyle("{$letters[$letterCounter]}{$rowNo}")->getNumberFormat()->setFormatCode('#,##0');
        $letterCounter+=2;
        $sheet->setCellValue("{$letters[$letterCounter]}{$rowNo}", $data['q4']['debt_repayment']);
        $sheet->getStyle("{$letters[$letterCounter]}{$rowNo}")->getNumberFormat()->setFormatCode('#,##0');
        $letterCounter+=2;
        $sheet->setCellValue("{$letters[$letterCounter]}{$rowNo}", 0);
        $sheet->getStyle("{$letters[$letterCounter]}{$rowNo}")->getNumberFormat()->setFormatCode('#,##0');

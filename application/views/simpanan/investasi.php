                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-5">
                                <select class="form-control form-control-user" id="statusCombo" name="status" disabled="disabled">
                                    ...
                                    <option value="investasi" <?=(isset($module) && $module == 'investasi')? 'selected' : '' ?>>Investasi</option>
                                </select>
                            </div>
                        </div>
                        <div class="row mb-3">
...
<script>
    ...
    let dt = $('#simpananTable').DataTable({
        dom: "Bfrtip",
        ajax: {
            url: url.site + "/simpanan/get_dt_simpanan_investasi",
            type: "POST",
            data: function(d){
                d.month = month;
                d.year = year;
    ...
    $(document).ready(function() {
        ...
        $("#anggotaSelect").change(function () {
            ...
            if(person.length > 0){
                ...
                $('#jumlahTextInput').val(person[0].investasi)
            }else{
                $('#anggotaAlert').fadeIn();

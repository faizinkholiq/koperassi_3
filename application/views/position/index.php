...
<div class="card shadow mb-4">
    <div class="card-body">
        <a href="<?= site_url('position/create') ?>" class="btn my-btn-primary mr-2"><i class="fas fw fa-plus mr-1"></i> Tambah baru</a>
        <hr>
        <div class="table-responsive">
            <table id="positionTable" class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                <thead>
                    <tr>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="<?=site_url('position/edit/'.$row["id"])?>" class="btn btn-sm btn-primary"><i class="fas fa-edit mr-2"></i>Ubah</a>
